...
input_num1 = tk.Entry(window, fg="#008080", bg="Light gray", justify="center", highlightcolor="#008080", highlightthickness=2 )
...
input_num2 = tk.Entry(window, fg="#008080", bg="Light gray", justify="center", highlightcolor="#008080", highlightthickness=2)
...
etichetta.grid(row=5, column=1, sticky="N", ipady= 8)
...
div_button = tk.Button(text=":", bg="#008080", command= divisione)
div_button.place(x=170, y=180)
...
#etichetta risultato
etichetta=tk.Label(window, text="Risultato:", fg="#808080", font=("Verdana", 12), background="Light gray")
